...
import { Button, Flex, Heading, Text, Loader } from "@chakra-ui/react";
  ...
  return (
    <>
      {window.innerWidth < 768 ? (
        ...
        >
          <Heading>You cannot use this layout on mobile devices.</Heading>
          <Text>Please use a desktop or laptop for admin panel.</Text>
        </Flex>
      ) : (
        <Flex flexDir={"column"}>
          <Flex gap={2}>
